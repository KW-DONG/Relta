...
void Bsp_Microstep_force()
{
    GPIO_InitTypeDef GPIO_InitStructure;

    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOF|RCC_AHB1Periph_GPIOD|RCC_AHB1Periph_GPIOE, ENABLE);
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1|GPIO_Pin_12|GPIO_Pin_3;
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15|GPIO_Pin_9|GPIO_Pin_7|GPIO_Pin_13;
    GPIO_Init(GPIOE, &GPIO_InitStructure);

    GPIO_SetBits(GPIOF,GPIO_Pin_1|GPIO_Pin_12|GPIO_Pin_3);
    GPIO_SetBits(GPIOD,GPIO_Pin_8|GPIO_Pin_10);
    GPIO_SetBits(GPIOE,GPIO_Pin_15|GPIO_Pin_9|GPIO_Pin_7|GPIO_Pin_13);
